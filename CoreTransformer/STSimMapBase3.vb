...
MustInherit Class STSimMapBase3(Of T)
    Inherits STSimMapBase

    Private m_map As New MultiLevelKeyMap3(Of SortedKeyMap2(Of T))
    ...
    Protected Sub AddItem(
        ...
        Dim m As SortedKeyMap2(Of T) = Me.m_map.GetItemExact(k1, k2, k3)

        If (m Is Nothing) Then

            m = New SortedKeyMap2(Of T)(SearchMode.ExactPrev)
            Me.m_map.AddItem(k1, k2, k3, m)
    ...
    Protected Function GetItem(
        ...
        Dim p As SortedKeyMap2(Of T) = Me.m_map.GetItem(k1, k2, k3)
