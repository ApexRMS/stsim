...
Class StateClassQuickView
    ...
    Private Sub ConfigureContextMenus()
        ...
        Me.m_PTView.Commands.Add(New Command(ssl, AddressOf OnExecuteProbabilisticSSCommand, AddressOf OnUpdateProbabilisticSSCommand))
        Me.m_PTView.Commands.Add(New Command(tsl, AddressOf OnExecuteProbabilisticTSCommand, AddressOf OnUpdateProbabilisticTSCommand))
