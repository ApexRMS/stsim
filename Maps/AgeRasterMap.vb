...
Class AgeRasterMap
    ...
    Protected Overrides Sub Export(location As String, exportType As ExportType)
        ...
        Dim fileFilterRegex As String = ".*" & SPATIAL_MAP_AGE_VARIABLE_NAME & "\.(tif|vrt)$"
    ...
    Private Function CreateExportFilename(sourceName As String) As String
        Return sourceName.Replace(SPATIAL_MAP_AGE_VARIABLE_NAME, SPATIAL_MAP_EXPORT_AGE_VARIABLE_NAME)
    End Function
