...
MustInherit Class STSimMapBase6(Of T)
    Inherits STSimMapBase

    Private m_map As New MultiLevelKeyMap6(Of SortedKeyMap2(Of T))
    ...
    Protected Sub AddItem(
        ...
        ByVal k6 As Nullable(Of Integer),
        ByVal iteration As Nullable(Of Integer),
        ByVal timestep As Nullable(Of Integer),
        ByVal item As T)

        Dim m As SortedKeyMap2(Of T) = Me.m_map.GetItemExact(k1, k2, k3, k4, k5, k6)

        If (m Is Nothing) Then

            m = New SortedKeyMap2(Of T)(SearchMode.ExactPrev)
            Me.m_map.AddItem(k1, k2, k3, k4, k5, k6, m)
    ...
    Protected Function GetItem(
        ...
        Dim p As SortedKeyMap2(Of T) = Me.m_map.GetItem(k1, k2, k3, k4, k5, k6)
