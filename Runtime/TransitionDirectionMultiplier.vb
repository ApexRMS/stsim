...
Class TransitionDirectionMultiplier
    Inherits STSimDistributionBase

    Private m_TransitionGroupId As Integer
    Private m_CardinalDirection As CardinalDirection
    ...
    Public Sub New(
        ...
        Me.m_CardinalDirection = cardinalDirection
    ...
    Public ReadOnly Property CardinalDirection As CardinalDirection
        Get
            Return Me.m_CardinalDirection
        End Get
    End Property
