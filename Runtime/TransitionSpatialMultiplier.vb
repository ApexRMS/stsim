...
''' </summary>
''' <remarks></remarks>
Friend Class TransitionSpatialMultiplier

    Private m_TransitionSpatialMultiplierId As Integer
    ...
    Public Sub New(
        ByVal transitionSpatialMultiplierId As Integer,
        ...
        Me.m_TransitionSpatialMultiplierId = transitionSpatialMultiplierId
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public ReadOnly Property TransitionSpatialMultiplierId As Integer
        Get
            Return Me.m_TransitionSpatialMultiplierId
        End Get
    End Property
