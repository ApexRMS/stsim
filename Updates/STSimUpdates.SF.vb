...
Partial Class STSimUpdates
    ...
    ''' </remarks>
    Private Shared Sub UpdateStockFlowTables_SSIM_V_1(ByVal store As DataStore)

        If (store.TableExists("SF_Version")) Then

            Dim SFVersion As Integer = GetVersionTableValue(store, "SF_Version")
        ...
        If (store.TableExists("SF_StockGroup")) Then
        ...
        If (store.TableExists("SF_StockType")) Then
        ...
        If (store.TableExists("SF_FlowGroup")) Then
        ...
        If (store.TableExists("SF_FlowType")) Then
        ...
        If (store.TableExists("SF_Terminology")) Then
        ...
        If (store.TableExists("SF_InitialStockNonSpatial")) Then
        ...
        If (store.TableExists("SF_OutputOptions")) Then
    ...
    ''' </remarks>
    Private Shared Sub SF0000001(ByVal store As DataStore)

        If (Not store.TableExists("SF_FlowPathways")) Then
            Return
        End If
    ...
    ''' </remarks>
    Private Shared Sub SF0000002(ByVal store As DataStore)
    ...
    ''' 
    ''' </remarks>
    Private Shared Sub SF0000003(ByVal store As DataStore)
