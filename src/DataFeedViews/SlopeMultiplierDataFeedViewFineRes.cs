...
{
    internal partial class SlopeMultiplierDataFeedViewFineRes
    {
        public SlopeMultiplierDataFeedViewFineRes()
        {
            InitializeComponent();
        }
        ...
        private DataSheet GetDataSheet()
        {
            ...
            {
                return this.DataFeed.GetDataSheet(Strings.DATASHEET_DIGITAL_ELEVATION_MODEL_FINE_RES_NAME);
            }
            else
            {
                return null;
        ...
        {
            string RasterFile = RasterUtilities.ChooseRasterFileName("Digital Elevation Model File (Fine Resolution)", this);
