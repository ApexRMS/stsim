...
{
    internal partial class SpatialInitiationMultiplierDataFeedViewFineRes
    {
        public SpatialInitiationMultiplierDataFeedViewFineRes()
        {
            InitializeComponent();
        }
        ...
        public override void LoadDataFeed(SyncroSim.Core.DataFeed dataFeed)
        {
            ...
            this.m_MultipliersView.LoadDataFeed(dataFeed, Strings.DATASHEET_TRANSITION_SPATIAL_INITIATION_MULTIPLIER_FINE_RES_NAME);
        ...
        private void GetMultiplierFile(int rowIndex)
        {
            ...
            DataSheet ds = this.Scenario.GetDataSheet(Strings.DATASHEET_TRANSITION_SPATIAL_INITIATION_MULTIPLIER_FINE_RES_NAME);
