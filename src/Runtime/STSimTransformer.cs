...
namespace SyncroSim.STSim
{
    public partial class STSimTransformer : StochasticTimeTransformer
    {
        ...
        internal RandomGenerator m_RandomGenerator = new RandomGenerator();
        ...
        internal int m_TimestepZero;
        private bool m_IsSpatial;
        private bool m_IsMultiResolution;
        private bool m_ICDistributionsAutoGenerated;
        private StockFlowTransformer m_StockFlowTransformer;
        ...
        /// <summary>
        /// Gets whether this should be a multi-resolution run
        /// </summary>
        /// <value></value>
        /// <returns></returns>
        /// <remarks></remarks>
        public bool IsMultiResolution
        {
            get
            {
                return this.m_IsMultiResolution;
            }
            set
            {
                this.m_IsMultiResolution = value;
            }
        }

        /// <summary>
        /// Gets the initial conditions spatial datasheet name
        /// (depends on whether the run is fine resolution or base resolution)
        /// </summary>
        /// <value></value>
        /// <returns></returns>
        /// <remarks></remarks>
        public string InitialConditionsSpatialDatasheet
        {
            get
            {
        ...
        private void InternalOnIteration(int iteration)
        {
            ...
            // DEV TODO: handle tabular output when multiresolution
        ...
        private void InternalOnTimestep(int iteration, int timestep)
        {
            ...
            //Tabular data
            // DEV TODO: Do not report multiresolution tabular data for now
            if (!this.IsMultiResolution)
            {
        ...
        internal DeterministicTransition GetDeterministicTransition(Cell simulationCell, int iteration, int timestep)
        {
