...
namespace SyncroSim.STSim
{
    internal static class Constants
    {
        ...
        public const string EXTPROC_ENVIRONMENT_BEFORE_ITERATION = "SSIM_STOCHASTIC_TIME_BEFORE_ITERATION";
        public const string EXTPROC_ENVIRONMENT_AFTER_ITERATION = "SSIM_STOCHASTIC_TIME_AFTER_ITERATION";
        public const string EXTPROC_ENVIRONMENT_BEFORE_TIMESTEP = "SSIM_STOCHASTIC_TIME_BEFORE_TIMESTEP";
        public const string EXTPROC_ENVIRONMENT_AFTER_TIMESTEP = "SSIM_STOCHASTIC_TIME_AFTER_TIMESTEP";
    }
}
