...
namespace SyncroSim.STSim
{
    internal static class MessageStrings
    {
        ...
        public const string STATUS_SPATIAL_FILE_TSM_ROW_COLUMN_MISMATCH = "The Transition Spatial Multiplier file '{0}' number of rows and/or columns did not match that of the Initial Condition Primary Stratum raster file.";
        ...
        public const string STATUS_SPATIAL_FILE_TSIM_ROW_COLUMN_MISMATCH = "The Transition Spatial Initiation Multiplier file '{0}' number of rows and/or columns did not match that of the Initial Condition Primary Stratum raster file.";
