...
namespace SyncroSim.STSim
{
    ...
    internal static class TerminologyUtilities
    {
        ...
        /// <remarks></remarks>
        public static void GetAmountLabelTerminology(DataSheet terminologyDataSheet, ref string amountLabel, ref TerminologyUnit amountUnits)
        {
        ...
        /// <remarks></remarks>
        public static void GetStateLabelTerminology(DataSheet terminologyDataSheet, ref string slxlabel, ref string slylabel)
        {
            DataRow dr = terminologyDataSheet.GetDataRow();
