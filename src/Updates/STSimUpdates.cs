...
namespace SyncroSim.STSim
{
    internal partial class STSimUpdates : UpdateProvider
    {
        ...
        private static void STSIM0000045(DataStore store)
        {
            ...
            DataTable dt = store.CreateDataTable("core_Scenario");
        ...
        private static void STSIM0000058(DataStore store)
        {
            ...
            DataTable dtScenarios = store.CreateDataTable("core_Scenario");
        ...
        /// <remarks>
        /// This update:
        /// 1.  Adds Transition Event related fields to the STSim_OutputOptions table.
        ...
        {
            UpdateProvider.RenameTable(store, "STSim_Processing", "stsim_Multiprocessing", true);
            UpdateProvider.RenameTablesWithPrefix(store, "STSim_", "stsim_");
            UpdateProvider.RenameInputFoldersWithPrefix(store, "STSim_", "stsim_");
            UpdateProvider.RenameOutputFoldersWithPrefix(store, "STSim_", "stsim_");
